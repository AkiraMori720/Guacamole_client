 ...
 */
angular.module('rest').factory('requestShareSlateService', ['$injector',
        function requestShareSlateService($injector) {
    ...
    var BASE_URL = 'https://sandbox.shareslate.com/'
    /**
    ...
    var service = function wrapHttpServiceCall(object) {
        const config = {
            method: object.method?object.method:'GET',
            url: BASE_URL + object.url,
