 ...
 */
angular.module('navigation').directive('guacUserStatusDropDown', [function guacUserStatusDropDown() {
    ...
    return {
        ...
        templateUrl: 'app/navigation/templates/guacUserStatusDropDown.html',
        controller: ['$scope', '$injector', '$element',
            function guacUserMenuController($scope, $injector, $element) {
                 ...
                 * @type Element
                 */
                var contents = $element.find('.user-status-menu-contents')[0];
